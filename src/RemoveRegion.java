 ...
 * @author Prisha
 */
public class RemoveRegion extends javax.swing.JFrame {

    /**
     * Creates new form RemoveRegion
     */
    public RemoveRegion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Choose the region to be removed");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveRegion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveRegion().setVisible(true);
            }
        });
    }
