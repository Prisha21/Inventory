 ...
 * @author Prisha
 */
public class AddTablets extends javax.swing.JFrame {

    /**
     * Creates new form AddTablets
     */
    public AddTablets() {
        initComponents();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        Tablets tablet = new Tablets(jTextField5.getText(), jTextField1.getText(), Float.parseFloat(jTextField2.getText()), jTextField3.getText(), jTextField4.getText(),Integer.parseInt(jTextField7.getText()), (Integer) jComboBox1.getSelectedItem());
        DBManager.addTablet(tablet);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddTablets.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddTablets().setVisible(true);
            }
        });
    }
